...
<c:if test="${sessionScope.memId != null }" >
	<c:redirect url="/moamore/dashboard.moa"/>
</c:if>
	...
	<div class="sitetop"> 
		...
		<div class="wel_Title"><p class="mb-4"> 예산을 설정하고, 돈을 모아 목표를 달성하세요!</p></div>
	 	 <c:if test="${sessionScope.memName == null }" >
               <div class="tu_btn"><button class="sign_btn btn" onclick="location.href='/moamore/member/signupForm.moa' ">회원가입 하러 가기</button> &nbsp;
               	<button class="btn-primary btn" onclick="location.href='/moamore/member/loginForm.moa' ">로그인하기</button>
               </div>
          </c:if>
	</div> 
	  <div class="totalImgBox">
	  		...
	  		<div class="imgbox">
	  			<div class="tu_img shadow h-100 py-2"><img src="/moamore/resources/img/goalList.png" /> </div>
	  			<p class="img_title text-gray-900">2.목표를 설정하세요. 티클모아 태산! 하루하루 조금씩 모아 목표를 이루는 재미를 느껴봐요.<br>
	  											    다른사람들과 함께 목표를 공유할 수도 있습니다.  </p>
	  		</div>
	  		<div class="imgbox">
	  			<div class="tu_img shadow h-100 py-2"><img src="/moamore/resources/img/insert.png" /> </div>
	  			<p class="img_title text-gray-900">3.수입 지출을 입력하세요. 예산외 지출, 예산외 수입, 예산내 지출로 잘 나눠서 입력해주세요.</p>
	  		</div>
	  		<div class="imgbox">
	  			<div class="tu_img shadow h-100 py-2"><img src="/moamore/resources/img/transfer.png" /> </div>
	  			<p class="img_title text-gray-900">4.남은 예산을 분배하세요. 현재 예산 재분배와 목표로 보내기 중 선택할 수 있습니다.  </p>
	  		</div>
	  		<div class="imgbox">
	  			<div class="tu_img shadow h-100 py-2"><img src="/moamore/resources/img/budgetReport.png" /> </div>
