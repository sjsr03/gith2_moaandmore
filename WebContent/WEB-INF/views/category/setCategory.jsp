...
$(document).ready(function(){
	...
	$("#inputCategory").click(function(event){ 
		...
		console.log($("#categoryOption").val());
		//data :{"category_name": $('#category_name').val(),"categoryOption": categoryOption },  이거 왜 안되는지 모르겠음 
    ...
    $.ajax({
        ...
        success : function(outcome){
      		...
      		for (var i = 0; i < outcome.length; i++) {
      				...
      				categoryNum=outcome[i].category_no;
	            	html += "<td>";
	            	html += "<div class='cat_btn'>";
	            	html += "<i class='fas fa-ellipsis-v'></i>";
	            	html += "<div class='my_sub'>";
	            	html +="<p>"
	                html +="<a href='deleteCategory.moa?category_no="+categoryNum+"&inorout=outcome'>삭제하기</a>";
