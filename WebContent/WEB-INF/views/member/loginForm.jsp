              ...
              <div class="col-lg-6">
                <div class="p-5">
                  ...
                  <input type="hidden" name="referrer" id="referrer"/>
                    ...
                    <div class="form-group">
                      <input type="password" class="form-control form-control-user" name="pw" required id="exampleInputPassword" placeholder="비밀번호">
                    </div>
                    <div class="form-group">
                      <div class="custom-control custom-checkbox small">
                        <input type="checkbox" class="custom-control-input" id="customCheck" name="auto">
                  ...
                  <hr>
                  <div class="text-center">
                    <a class="small" href="/moamore/member/signupForm.moa">회원가입</a>
                  </div>
                </div>
              </div>
            </div>
