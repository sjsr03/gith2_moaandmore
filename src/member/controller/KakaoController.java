...
public class KakaoController {
	...
	private final static String K_CLIENT_ID = "e9c0f6009ba4056806aa70735e1bdcd7";
    private final static String K_REDIRECT_URI = "http://localhost:8080/moamore/member/kakaologin.moa";

    //K_REDIRECT_URI 얘는 인증 코드를 받으면 redirect 될 주소 (즉 로그인이 성공했을 때)
